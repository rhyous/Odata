...
namespace Rhyous.Odata
{
    ...
    {
        /// <summary>
        /// Whichever entity will have less instances should be Entity1. If this mapping entity maps and entity to an
        /// entity group, then entity1 should be the group.
        /// For example, for User, UserGroup, UserGroupMembership, Entity1 should be UserGroup.
        /// </summary>
        public string Entity1 { get; set; }

        /// <summary>An alias name for Entity1</summary>
        public string Entity1Alias { get; set; }

        /// <summary>If not specified, "Id" will be append to the value of Entity1.</summary>
        ...
        /// <summary>
        /// Consider not set if null, empty, or whitespace. This allows for renaming one entity when both mappings
        /// are for the same entity.
        /// </summary>
        public string Entity1UriTemplate { get; set; }

        /// <summary>
        /// Whichever entity will have more instances should be Entity2. If this mapping entity maps and entity to an
        /// entity group, then entity2 should be the entity not the group.
        /// For example, for User, UserGroup, UserGroupMembership, Entity2 should be User.
        /// </summary>
        public string Entity2 { get; set; }

        /// <summary>An alias name for Entity2</summary>
        public string Entity2Alias { get; set; }

        /// <summary>If not specified, "Id" will be append to the value of Entity2.</summary>
