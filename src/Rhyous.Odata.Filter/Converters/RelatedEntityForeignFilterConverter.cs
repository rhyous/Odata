...
namespace Rhyous.Odata.Filter
{
    ...
    public class RelatedEntityForeignFilterConverter<TEntity> : IRelatedEntityFilterConverter<TEntity>
    {
        ...
        public RelatedEntityForeignFilterConverter(CsdlSchema csdlSchema,
        ...
        private bool IsCsdlSchemaValid(Filter<TEntity> filter)
        {
            return _CsdlSchema.Entities.TryGetValue(typeof(TEntity).Name, out object objCsdl)
                ...
                && value.ToString() == CsdlConstants.Foreign;
        }
    }
}