...
namespace Rhyous.Odata.Csdl
{
    public static class RelatedEntityAttributeExtensions
    {
        ...
        public static RelatedEntityAttribute Merge(this RelatedEntityAttribute re1, RelatedEntityAttribute re2)
        {
            ...
            mergedAttribute.EntityAlias = string.IsNullOrWhiteSpace(re1.EntityAlias) ? re2.Entity : re1.EntityAlias;
            ...
            mergedAttribute.ForeignKeyProperty = string.IsNullOrWhiteSpace(re1.ForeignKeyProperty) ? re2.ForeignKeyProperty : re1.ForeignKeyProperty;
